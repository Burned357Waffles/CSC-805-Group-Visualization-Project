        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 space-y-6">
            ...
            <section aria-labelledby="kpi-ribbon">
              <h2 id="kpi-ribbon" className="sr-only">Key Indicators</h2>
              <KpiRibbon />
            </section>

            {/* Choropleth */}
            <section className="rounded-xl border bg-white shadow-sm" aria-labelledby="choropleth-title">
            ...
            {/* Timeline */}
            <section className="rounded-xl border bg-white shadow-sm" aria-labelledby="timeline-title">
